...
<div class="content-right">
	...
	<div class="content-text">
		<div class="square-order">
			<form action="${pageContext.request.contextPath}${model.menu_id==null?'/menu/menu_add':'/menu/menu_update'}" method="post">
  			...
  			<div style="border:1px solid #cecece;">
				...
				<table width="100%"  border="0" cellpadding="0" cellspacing="0">
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td width="32%">
				      	<select style="width:190px" name="parent_menu.menu_id">
				      		
				      		<s:iterator value="menus" var="menu">
				      			<option value="${menu.menu_id }" ${model.menu_id==menu.menu_id?'checked':'' }>${menu.name }</option>
				      		</s:iterator>
				      	</select>
				      </td>
				    </tr>
				    ...
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td width="82%" colspan="3">
				      	<input type="text" size="82" name="path" value="${model.path }"/>
				      </td>
				    </tr>
				    <tr  bgcolor="#FFFFFF">
				      <td colspan="4">&nbsp;</td>
				    ...
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td width="82%" colspan="3">${rolesAll.size() }
				      <s:iterator value="rolesAll" var="role">
				      	<input type="checkbox" name="role_ids" value="${role.role_id}" ${role_ids.contains(role.role_id)?'checked':''}/>${role.name }
				      </s:iterator>
				      </td>
				    </tr>
				    <tr  bgcolor="#FFFFFF">
