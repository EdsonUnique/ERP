...
<script type="text/javascript">
	...
	<div class="content-text">
		<div class="square-order">
			<form action="${pageContext.request.contextPath }${model.did==null? '/department/dept_add':'/department/dept_update'}" method="post">
  			<div style="border:1px solid #cecece;">
				...
				<table width="100%"  border="0" cellpadding="0" cellspacing="0">
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td width="32%">
				      	<input type="text" name="name" size="25" value="${model.name }"/>
				      </td>
				      <td width="18%" align="center">电话</td>
				      <td width="32%">
				      	<input type="text" name="telephone" size="25" value="${model.telephone }"/>
				      </td>
				    </tr>
				    <tr  bgcolor="#FFFFFF">
				      <td colspan="4">&nbsp;</td>
