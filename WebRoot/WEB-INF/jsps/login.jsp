	...
	<div class="container-login">
		<div class="login-pic">
			<div class="login-text">
				<form action="${pageContext.request.contextPath }/employee/emp_login" method="post">
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td width="19%" height="28">用户名：</td>
							<td colspan="2">
								<input value="admin" type="text" name="name" size="18" />
							</td>
						</tr>
						<tr>
							<td height="31">密&nbsp;&nbsp;码：</td>
							<td colspan="2">
								<input value="admin" type="test" name="password" size="18" />
							</td>
						</tr>
						<tr>
							<td height="30">验证码：</td>
