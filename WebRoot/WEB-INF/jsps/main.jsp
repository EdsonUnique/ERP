...
<body>
	<div class="container">
		<div class="head">
			<div class="head-left">
				<span style="color:#4a940d">${login_emp.name }</span>
				<span style="font-weight:bold; color:#1f4906">欢迎您-</span>
			</div>
			<div class="head-right">
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td width="32%">
							<a href="${pageContext.request.contextPath}/employee/emp_changePwdUI" target="main">
								<img src="${pageContext.request.contextPath}/images/head-l.gif"	border="0" />
							</a>
						</td>
						<td width="26%">
							<a href="${pageContext.request.contextPath}/employee/emp_logout">
		...
		<div class="footer">
			...
			<%@include file="/WEB-INF/jsps/dept/mask.jsp" %>
		</div>
		<!--"footer"end-->
	</div>
	<!--"container"end-->
